...
#define PD_MIN_PULSES 16			// Minimum number of pulses before declaring a proper package 16
...
#define PD_MAX_PULSE_MS 10 			// Pulse width in ms to exceed to declare End Of Package (e.g. for non OOK packages)
