...
#define OOK_HIGH_LOW_RATIO	800			// Default ratio between high and low (noise) level
#define OOK_MIN_HIGH_LEVEL	2			// Minimum estimate of high level
#define OOK_MAX_HIGH_LEVEL	(128*128*128)	// Maximum estimate for high level (A unit phasor is 128, anything above is overdrive)
