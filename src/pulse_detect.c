...
#define OOK_HIGH_LOW_RATIO	80			// Default ratio between high and low (noise) level
...
#define OOK_EST_HIGH_RATIO	64*100		// Constant for slowness of OOK high level estimator
#define OOK_EST_LOW_RATIO	1024/200		// Constant for slowness of OOK low level (noise) estimator (very slow)1024
