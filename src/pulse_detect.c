...
#define OOK_EST_HIGH_RATIO	64/64		// Constant for slowness of OOK high level estimator
#define OOK_EST_LOW_RATIO	1024*100		// Constant for slowness of OOK low level (noise) estimator (very slow)1024
