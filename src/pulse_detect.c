...
#define OOK_HIGH_LOW_RATIO	128			// Default ratio between high and low (noise) level
#define OOK_MIN_HIGH_LEVEL	2			// Minimum estimate of high level
#define OOK_MAX_HIGH_LEVEL	(128*128*16)	// Maximum estimate for high level (A unit phasor is 128, anything above is overdrive)
#define OOK_MAX_LOW_LEVEL	(OOK_MAX_HIGH_LEVEL/2)	// Maximum estimate for low level
#define OOK_EST_HIGH_RATIO	(64*16)			// Constant for slowness of OOK high level estimator
#define OOK_EST_LOW_RATIO	(1024*16)		// Constant for slowness of OOK low level (noise) estimator (very slow)1024
